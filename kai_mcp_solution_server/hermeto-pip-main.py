...
def fetch_pip_source(request: Request) -> RequestOutput:
    ...
    shutil.copy('hermeto-output/deps/pip/maturin-7009568c272569a73d0c6b9861af6a5705d4e0506a730b6fbeccf4917833da84.tar.gz', 'hermeto-output/deps/pip/maturin-1.8.7.tar.gz')
    file = tarfile.open('hermeto-output/deps/pip/maturin-1.8.7.tar.gz') 
    file.extractall('./hermeto-output/deps/pip/') 
    file.close()

    shutil.copy('hermeto-output/deps/pip/jiter-14b1bf683b341d9ae78d9ec625757108a025750bc63b940b3183b96b1c366a0d.tar.gz', 'hermeto-output/deps/pip/jiter-0.10.0.tar.gz')
    file = tarfile.open('hermeto-output/deps/pip/jiter-0.10.0.tar.gz') 
    file.extractall('./hermeto-output/deps/pip/') 
    file.close()

    shutil.copy('hermeto-output/deps/pip/tiktoken-d9ad52c4e2ff5f04873285c2b19a83ff7aad29da72ab1ab9ab16b838bf14ff5c.tar.gz', 'hermeto-output/deps/pip/tiktoken-0.9.0.tar.gz')
    file = tarfile.open('hermeto-output/deps/pip/tiktoken-0.9.0.tar.gz') 
    file.extractall('./hermeto-output/deps/pip/') 
    file.close()

    shutil.copy('hermeto-output/deps/pip/zstandard-4bd4b4d415105f18da4d3256975fb070833bb30268839f2204ebc9295d1da5b6.tar.gz', 'hermeto-output/deps/pip/zstandard-0.23.0.tar.gz')
    file = tarfile.open('hermeto-output/deps/pip/zstandard-0.23.0.tar.gz') 
    file.extractall('./hermeto-output/deps/pip/') 
    file.close()

    shutil.copy('hermeto-output/deps/pip/pydantic-core-ca5e5f0655dcd7425f5378bb57b9faaccbc91d8ce04063ca001eec2fb0786376.tar.gz', 'hermeto-output/deps/pip/pydantic_core-2.33.2.tar.gz')
    file = tarfile.open('hermeto-output/deps/pip/pydantic_core-2.33.2.tar.gz') 
    file.extractall('./hermeto-output/deps/pip/') 
    file.close()
